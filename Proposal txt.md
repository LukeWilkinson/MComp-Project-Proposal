...
This project intends to explore and analyse the different effects and influences a crowd presents when video games are being played. With the many different forms of crowds in and out of games there is a lot of room for exploration and investigation into this subject, such as; the amount of pressure that a player is put under in the presence of different crowds, the players enjoyment of the game, do the specific people in the crowd change the way the player performs, and much more. The intended result of this project is to analyse and evaluate the effects that a crowd has on a person when playing a game, to see if the different crowds effect the way that a person performs when playing a game, exploring what could stimulate a player to perform in what manner depending on the crowd and the feedback they given the player.

It is rather uncommon these days for someone to have not been part of a video game crowd in some way, from playing games with friends or family and playing games online to watching lets plays, streamed games or e-sports. Even with these forms of video game crowds, which seem rather common these days, it is possible that a player’s performance or enjoyment could be skewed by them. It would not be preposterous to assume that some players would enjoy the game they are playing more because they are playing with their friends or family. Similarly it would not be unreasonable to assume that some players would perform a lot better in game when they are alone because there will be less distractions allowing them to focus on the game, however this may not be the case for some players. Some people may be more relaxed on their own, but in front of a large crowds of people some people may perform to a higher standard because of the pressure of playing while people are watching.

For this project there will a number of different types of crowds that will be investigated and used in the test scenario(s), including: self as audience (self-deliberation), small group of friends, audience on the web and a large audience. Each of these audiences could alter the performance of the player in a number of varying ways, each pose different factors that can put different amounts of pressure on the player to perform. For example, cheering and booing and other forms of encouragement or discouragement could make the player put different amounts of effort in to the game they are playing. If a player is being cheered on it is likely that they will try harder to keep up the crowd’s reaction, if the player is being booed then the opposite could happen and they may put less effort in to winning because they may not even get any appreciation or recognition from the audience if they win. Opposed to this if the player is being booed then they may put even more effort in to playing the game to prove the crowd wrong, giving them the satisfaction of showing others that they are capable of completing a task even when everyone else is against them. If the player is on their own as a self-audience then the only people they are performing for is themselves so the only encouragement or discouragement they will receive will be from themselves. This project intends to determine which these theories of the outcomes of the different crowd participation scenarios are true and if there is a preferred audience that made the players excel in their performance, or if there was an audience that gave them the most enjoyment from the game.

This project will be testing the four types of crowds mentioned above, self as audience, small group of friends, audience on the web and a large audience in a few different ways. Many different factors will be altered during the different test scenarios, the main factor that will be altered will be the crowd’s reaction to the player, there will be some tests where the audience may be manipulated, so the crowd may be prompted to cheer for a player or boo a player at different times during different tests, to observe the effects that they have on the players overall experience.

Self as audience will serve as the base tests to compare the other results against, because there is no audience to effect the player’s performance it should be easy to see the crowds influence based on this test, the player will play two (or more, this could altered if needed) rounds/games of the chosen test game. Small group of friends will require a player to play in the presence of 3-7 of their friends, this could affect the player in many different ways, with the audience and the player having a relationship it is unpredictable how the player will do or what the audience will do for the first test with friends. The next test with friends will add the crowd manipulation, with the crowd being prompted to side either with or against the player at different points during the game, maybe being told to laugh, applaud, cheer, boo or make no reaction, seeing how the player is affected, this scenario will be the same for the large crowd, the main change being that the audience will be 20+ people that the player may or may not know. Audience on the web will consist of the game being streamed online on a site like Twitch, because the audience has no way to verbally interact with the player in this scenario the text chat will be the main way in which the player can observe feedback from the audience, again there will be one test where the audience will act normally and a second where they will be prompted to side with or against the player throughout the game.

Once the results of this project have been produced and analysed a report and design guidelines will be produced to display what the most commonly preferred scenario considering a number of factors including, but not limited to level of enjoyment felt from the player and player performance. If there are any other possible factors that may be interesting and useful to analyse and discuss they will be discovered through the full literature review and research that will be completed in this project.
...
To evaluate and analyse the performance and enjoyment of a player when playing video games in front of different crowds, to see if their gaming experience or performance could be influenced by the reactions of the crowd, producing a report and design guidelines from the results found from this project.

Objectives:

•	Explore and analyse different forms of crowds that would be best to use and evaluate with players in test scenarios, this will be composed within a literature review.
...
•	Plan a study/test scenario based on the effect of manipulated crowds over non-manipulated crowds could have on the player(s) based on subjects covered in the literature review. Including recruiting test subjects and audience members and booking rooms for the tests to be carried out in.

•	Complete pilot tests for the study and re-plan these tests based on the findings and success of the pilot test.

•	Conduct the real test from the plan produced.

•	Analyse the findings of the test for the study, documenting any notable or interesting findings.

•	Plan a second study/test scenario based on the effect manipulated crowd audio over non-manipulated crowd audio could have on the player(s) based on subjects covered in the literature review. Again including recruiting test subjects and audience members and booking rooms for the tests to be carried out in.

•	Complete pilot tests for the second study and re-plan these tests based on the findings and success of the pilot test.

•	Conduct the second real test from the plan produced.

•	Analyse the findings of the second test for the study, documenting any notable or interesting findings.

•	Evaluate all of the findings from all of the tests completed finding and evident facts or noteworthy data found to produce some design guidelines that would be useful when working with crowds in video games.
...
Video games are games that are played electronically that provide a source of entertainment to the user, allowing them to simulate and relate to almost anything imaginable. Whether it be something as simple as playing a game of football or something as complex as fighting giant monsters in space (Grodal et al, 2000). With the recent raising craze of lets plays, streamers and e-sports it is clear to see that entertainment can come from watching someone else play video games as well as playing them, “in fact, in a recent social study, casual players were found to prefer watching professional gamers rather than playing the game themselves” (Kayoute et al, 2012). This is no real surprise as this has also been the case for real sports for years, it would seem that most people would watch more European football games than they would play for themselves, the average attendance at English football stadiums in 2014/2015 was in the 10,000’s, some reaching as high as 75,000 as an average (Heimspiel Medien GmbH & Co. 2014).

In the past few decades it has become more and more common that a person would be brought up with or would own a video game console, one study found that “more than two-thirds of all children ages 2-18 live in a home with a video game system” (Henry J. Kaiser Family Foundation, 2002). With growing up with video games being the norm now, it is understandable that most people are playing these games with friends, family or others online. Either taking turns, playing with or against people, or simply watching others play video games includes some kind of crowd presence, even if it is just with a small group of friends or family. This social event is clearly a preferred form of entertainment in most households, shown by a study completed in 2013. The study found that 62% of the gamers played with others, either online or in person, 77% of which played with others for at least an hour a week, mainly playing with friends or family members (Entertainment Software Association, 2013).

Crowds

Crowds can definitely vary in many different ways, one clear variation in a crowd is what side that it is routing for, is the side cheering for you, or against you? Whether you’re playing against an opponent or not this could occur. This is clear to see in some formats, for instance, sports games will have two main types of attendees, home team supporters and away team supporters. It would not be unreasonable to assume that there would be more home team supporters as the game, as it would presumably be more accessible to those from the home town. A study into crowd effect on sports in performance found that, if the home team crowds were bigger then the percentage of home team wins would be higher (Agnew and Carron, 1994). This can however work both ways, as the home team would presumably have more supporters spectating, this would also mean that there would be more pressure put to them to perform, giving the away team an advantage as there would be less disappointed physical spectators if they lost, and the satisfaction of home team discouragement (Hallam, 2014).

Crowds are present in a number of forms and so are performers, the relationship between the two can vary depending on the situation and format in which the performance is presented to the audience in. The ‘humanaquarium’ project looked into a different way to present a performance to the audience, with different ways for audience to interact and participate with the performance. This project involved a movable performance space with two musicians performing inside the space which had a touch sensitive interface that allowed audience members to enter the performance frame and take an active role in the co-creation of a live audio-visual performance (Taylor et al. 2011). This project intended to allow the audience to interact with the performance in a new way, allowing the audience to directly participate with or alter the performance in a unique way that most individuals may not have seen before, allowing non-players roles to be changed in quite a drastic way considering the direct influence they could have on the performance.

Research into different types of crowds is limited and there is no absolute definition to the classification of different types of crowds. Multiple scholars have given their own categories to different types of crowds, including Momboisse who developed a system with four types of crowd: casual, conventional, expressive and aggressive (Momboisse, 1967), and Berlonghi who classified crowds as either spectator, demonstrator, or escaping (Berlonghi, 1995). Even though both of these systems are different, neither are wrong. Crowds can come in many different forms, which is why it is hard to have a final definition or type to categorize a specific crowd as. This study could take influence from both of these studies, Momboisse’s system could be present in some of the crowd types that will be present in the testing process, including aggressive and expressive, as there will be times that the crowd may willingly, or be prompted to cheer or boo a player, Berlonghi’s system could be seen within this project, mainly in the form of the spectator (as the observing crowd) and the demonstrator (as the active player).

Crowd manipulation will play a keen role in this project, as part of the testing process will involve manipulating the crowd to perform certain actions at specific times in an attempt to alter the game play experience for the player. Crowd manipulation is the direct and intentional instruction for a crowd to alter its behaviour depending on the instruction or scenario, one of the most common uses of crowd manipulation would be the ‘Applause’ sign’s that is present in television studios when a show is being filmed. These signs prompt the audience to perform specified actions in an attempt to provide the right atmosphere for a show, promoting things like applause, cheers, boo’s etc. Crowd manipulation employs methods which are principles of crowd psychology which are utilized in an attempt to engage, control and or influence the audience and their motives (Curtis, 2002). 
...
Non-players can be compared to non-playable characters (NPC’s) in video games (Wilkinson, 2015), they are people or characters that could provide information, goals, items/prizes, rules to be upheld or they may not even be required to the game and seem to have no purpose (Niemi et al, 2005). Obviously the non-players in this project will be the different crowds, the main analysis for the project is looking into the effects that these non-players can have on the players performing in the tests of this project, it will be interesting to see the effects that a similar group of non-players can have on player when they are presented in different formats, as in a crowd in person and a crowd online.

Social Facilitation

Social facilitation is an interesting topic within this project, social facilitation is the theory that people excel in performance when in the presence of others (Strauss, 2002). This project intends to explore deeper into this theory, analysing the different effects that different sizes of crowds and different reactions of crowds express can have on the person performing the task. There are obviously many different factors and variables that can determine the outcome of a game or performance, in 1982 a test was carried out on people playing pool with spectators watching to determine players level of skill. The study found that skilled players successfully made two thirds of all of their shots taken, but non-skilled players missed two thirds of their shots. The test was replicated this time with the spectators moved closer to the game, skilled players performance improved by 14% while non-skilled players performance decreased by over 30% (Michaels et al, 1982).

A study into social facilitation of dominant responses by the presence of an audience and the mere presence of others (Cottrell et al, 1968) tested a people in a number of different tests, which consisted of participants being asked to say made up words in a random order in different scenarios, alone, in front of two people and in front of a crowd of people, the test was described as “a study of how people learn a foreign language” (Cottrell et al, 1968). The results of the tests showed that the participants performance excelled when they were in front of a large audience, it would seem that the participants performed better when there was the pressure of the large crowd in front of them, the participants tried harder to succeed because people would see them if they failed. An interesting observation from this project is that there was only a slight increase in performance when two observers were present compared to the participant being alone during the test. These two observers were strangers to the subject but because there were so little of them the subject may not have felt under too much pressure to perform.

Electronic performance monitoring (EPM) is a method of monitoring a person’s performance with the utilization of information technologies, which in this project will be a streaming website or software. The player’s game will be streamed online so that a crowd of online observers can watch them playing the game, also the data that will be collected from the game that has been played could also be classed as a use of EPM. A study conducted in 2009 looked to determine the effect of EPM on students that have been using web-based training to learn new online search skills, the study found that students that were aware of the monitoring performed worse on a post-training skills test compared to those students that remained unaware of any monitoring that was going on (Thompson et al, 2009). Although these results may not have been preferable to the EPM method of monitoring and the social facilitation model, the findings did adhere to the basic premise that social facilitation presents, showing that the students with the knowledge of their monitoring had a heightened awareness when performing tasks.
...
The final artefact for this project as stated by the aims and objectives is a report, to ensure that this report is produced to the highest standards capable there are a number of steps which need to be taken, these can be laid out using a methodology plan. Even though this project involves no software development, many software development methodologies could still fit this project perfectly. 

Waterfall Method

The waterfall model follows a plan-driven process architecture where all the steps of the project are planned in stages before they can be started, this model is designed is an way that’s ordered so that only one step of the project can be worked on at a time, allowing the project to be divided into smaller chunks, making the work more manageable and easier to plan within the time span of the project life-cycle (Sommerville, 2010). The waterfall method could be utilized in this project as its structure is useful for time management and planning, the Gantt chart produced for this project shows some implication of the waterfall method, with some sections overlapping. This method is present in the projects current state, as the testing cannot be completed without thorough research being completed to ensure that all the necessary and relevant data can and will be collected for the project to be successful.

The Spiral Method

The spiral software development model is a risk-driven software process framework. The spiral model has some backtracking from one activity to another, unlike the waterfall model, this allows some flexibility within the project, meaning that until the end of the project no section is considered fully finalized, always allowing for more additions, alterations or improvements. The spiral of activities loops, in each loop the spiral can represent different events or milestones within the project, continuously looping to the next stage or process. The spiral’s loops can be split into multiple sections: objective settings, this is when objectives are created/developed; risk assessment, when risks are identified, evaluated and resolved; development and validation, this would be when a development model is chosen then the development within the project can begin; planning is where the project is finally reviewed and the decision of whether to continue the loop is made (Sommerville, 2010).

Research Methods

Extensive research will continue until the final completion of this project, there will be thorough research into all of the key topics and areas of interest, mainly consisting of research into crowds and audiences, video games, social facilitation and player enjoyment and performance with the crowd influence. A great deal of effort will go into investigating these key fields to ensure that the findings of this project are accurate and relevant, looking into great detail on how the crowd/audience can affect the player’s performance, enjoyment and experience whilst playing the game.
...
Crowd research will involve looking into different forms of crowds that can be present within different forms of media events, and the amount of influence that crowds can have or are given. For example crowds at a traditional English pantomime will have more influence with the performance over crowds observing a game of golf, this is because pantomime crowds are expected to feel like they are part of the performance, interacting directly with the talent on stage. Whereas crowds at a golf game are expected to be quite for a lot of the game to allow the players to concentrate when they are taking a shot, only providing encouragement once the shot has been taken. Research into different scholars and their theories into how to classify crowds and the different types of crowds that have already been defined will be completed, with the final intent of finding out what key factors of a crowd influence a players behaviour, emotional state and performance.
...
Overworking	Researcher spending too much time on the project and potentially effecting the researchers health and wellbeing	High	Low	Keep to the schedule produced for this project within the Gantt chart and if work gets too over whelming discuss the problem with the project supervisor.
...
Curtis, A. (2002). The Century of the Self (documentary), British Broadcasting Cooperation (United Kingdom: BBC4, 2002).
...
Momboisse, R. M. (1967). Riots, revolts, and insurrections. CC Thomas.
...
Niemi, K., Sawano, S. & Waern, A. (2005) Involving non-players in pervasive games. In Proceedings of the 4th decennial conference of Critical computing: between sense and sensibility (pp. 137 - 140).

Sommerville, I. (2010) Software Engineering Ninth Edition. Pearson.
...
Thompson, L. F., Sebastianelli, J. D. & Murray, N. P. (2009). Monitoring Online Training Behaviors: Awareness of Electronic Surveillance Hinders E‐Learners1. Journal of Applied Social Psychology, 39(9), 2191-2212.

Wilkinson, L. (2015). Investigating mechanics designed for pervasive games in unique social environments. Undergraduate Dissertation. University of Lincoln.
